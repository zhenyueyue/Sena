...
- Right-clicking the visible pet body opens a native Windows shortcut menu for **Settings**, **80% / 100% / 120% size**, **Always on top**, and **Exit**. The current size and always-on-top state use native check marks, and the menu shares the same action handler as the tray controls.
